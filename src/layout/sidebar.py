                ...
                [
                    dbc.CardBody(
                        [
                            ...
                            html.Label(
                                "Organización",
                                className="fw-bold text-muted small text-uppercase mb-1",
                            ),
                            dcc.Dropdown(
                                id="drop-org",
                                options=org_options,
                            ...
                            html.Label(
                                "Ubicaciones",
                                className="fw-bold text-muted small text-uppercase mb-1 mt-2",
                            ),
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.Label(
                                        ...
                                        className="fw-bold text-muted small text-uppercase mb-3 mt-3",
                                    ),
                                    dbc.RadioItems(
                                        id="tipo-fecha",
                                        options=[
